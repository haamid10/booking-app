     ...
     {action === 'new' && (
      <div className="0 ">
        ...
        <form action="">
          ...
          <p className="text-gray-500 mt-4"> house  rules , etc</p>
          <textarea name="" id=""  />
          <h2 className="text-xl mt-4">Check in&out times</h2>
          <p className="text-gray-500 mt-4">add check in and out times , remember to have some time window for cleaning between guests  </p>
