  ...
  return (
    ...
    <p className="text-gray-500 mt-4"> select all the perks of the place</p>
     <div className="grid mt-2 gap-1 grid-cols-2 md:grid-cols-4 lg:grid-cols-6">
      <label className="border  p-4 flex rounded-2xl gap-2 item-center justify-center cursor-pointer"   htmlFor="">
      ...
      <label className="border  p-4 flex rounded-2xl gap-2 item-center cursor-pointer"   htmlFor="">
        <input name="free parking" type="checkbox" onChange={ handleClick} />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <label className="border  p-4 flex rounded-2xl gap-2 item-center cursor-pointer"   htmlFor="">
        <input name="Radio" type="checkbox" onChange={ handleClick} />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <label className="border p-4 flex rounded-2xl gap-2 item-center cursor-pointer"   htmlFor="">
        <input name="private Entrance" type="checkbox" onChange={ handleClick} />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
